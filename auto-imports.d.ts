...
declare global {
  ...
  const createConvex: typeof import('./src/utils/convex')['createConvex']
  ...
  const useConvex: typeof import('./src/utils/convex')['useConvex']
  const useConvexAuth: typeof import('./src/utils/convex')['useConvexAuth']
  const useConvexAuth0Provider: typeof import('./src/utils/convex')['useConvexAuth0Provider']
  ...
  const useMutation: typeof import('./src/utils/convex')['useMutation']
  ...
  const useQuery: typeof import('./src/utils/convex')['useQuery']
  ...
  const useSuspenseQuery: typeof import('./src/utils/convex')['useSuspenseQuery']
